...
const basePromptExploring = `You are esentially the dungeon master for this player that returns only a json object as described below. 
        ...
        Any changes in food, ship quality, gold, fame, etc. should be explicitly stated (why it happened). Fame should only be given out once. Defeating a monster should increase fame as should meetin a god.
